#!/bin/bash
# Function		:Installs MN dependencies, Gexan and configures the gexan.conf file.
...
COIN_REPO='https://github.com/gexanlottery/gexan.git'
COIN_TGZ='https://github.com/gexanlottery/gexan/releases/download/v2.0.3.2/ubuntu16.04-daemon.zip'
...
function showbanner() {
echo "=============================================================================="
echo "                    Gexan Masternode Installer v1.0                  "
echo "=============================================================================="
echo "******************************************************************************"
echo "* This script will install and configure your Gexan masternode. It must be   *"
echo "* run as root, requires at least 1GB of RAM, 10GB of disk space and a Ubuntu *"
...
function download_node() {
  ...
  cd $TMP_FOLDER
  wget -q $COIN_TGZ
  unzip $COIN_ZIP -d /usr/local/bin/
  compile_error
...
apt-get update >/dev/null 2>&1
apt-get install -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" unzip make software-properties-common \
build-essential libtool autoconf libssl-dev libboost-dev libboost-chrono-dev libboost-filesystem-dev libboost-program-options-dev \
libboost-system-dev libboost-test-dev libboost-thread-dev sudo automake git wget curl libdb4.8-dev bsdmainutils libdb4.8++-dev \
libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev libboost-all-dev libdb5.3++ libzmq5 >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
...
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw fail2ban pkg-config libevent-dev libzmq5 libboost-all-dev"
 exit 1
fi
}
